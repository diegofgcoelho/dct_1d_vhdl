...
#set_property PACKAGE_PIN T18 [get_ports zoomin]
#set_property IOSTANDARD LVCMOS33 [get_ports zoomin]
#set_property PACKAGE_PIN W19 [get_ports dleft]
#set_property IOSTANDARD LVCMOS33 [get_ports dleft]
#set_property PACKAGE_PIN T17 [get_ports dright]
#set_property IOSTANDARD LVCMOS33 [get_ports dright]
#set_property PACKAGE_PIN U17 [get_ports zoomout]
#set_property IOSTANDARD LVCMOS33 [get_ports zoomout]
...
##Sch name = XA1_N
#set_property PACKAGE_PIN K3 [get_ports {Jvauxn6}]
...
#set_property PACKAGE_PIN N19 [get_ports {colorout[3]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {colorout[3]}]
#set_property PACKAGE_PIN N18 [get_ports {colorout[4]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {colorout[4]}]
#set_property PACKAGE_PIN L18 [get_ports {colorout[5]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {colorout[5]}]
#set_property PACKAGE_PIN K18 [get_ports {colorout[6]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {colorout[6]}]
#set_property PACKAGE_PIN J18 [get_ports {colorout[7]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {colorout[7]}]
#set_property PACKAGE_PIN J17 [get_ports {colorout[8]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {colorout[8]}]
#set_property PACKAGE_PIN H17 [get_ports {colorout[9]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {colorout[9]}]
#set_property PACKAGE_PIN G17 [get_ports {colorout[10]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {colorout[10]}]
#set_property PACKAGE_PIN D17 [get_ports {colorout[11]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {colorout[11]}]
